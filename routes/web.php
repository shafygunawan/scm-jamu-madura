...
use App\Http\Controllers\MaterialSupplierCatalogController;
...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/suppliers/katalog/create', [MaterialSupplierCatalogController::class, 'create'])->name('suppliers.katalog.create')->middleware('role:Admin|Manager');
    Route::post('/suppliers/katalog', [MaterialSupplierCatalogController::class, 'store'])->name('suppliers.katalog.store')->middleware('role:Admin|Manager');
    Route::get('/suppliers/katalog/{catalog}/edit', [MaterialSupplierCatalogController::class, 'edit'])->name('suppliers.katalog.edit')->middleware('role:Admin|Manager');
    Route::put('/suppliers/katalog/{catalog}', [MaterialSupplierCatalogController::class, 'update'])->name('suppliers.katalog.update')->middleware('role:Admin|Manager');
    Route::delete('/suppliers/katalog/{catalog}', [MaterialSupplierCatalogController::class, 'destroy'])->name('suppliers.katalog.destroy')->middleware('role:Admin|Manager');
